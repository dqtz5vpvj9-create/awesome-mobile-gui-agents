...
- [Pending review](PENDING.md)
- [Methodology](METHODOLOGY.md)
- [Contributing](#contributing)

## Mobile GUI Agents

Every entry links an official open-source implementation, a runnable mobile path, supporting evidence, and dated metadata. See [METHODOLOGY.md](METHODOLOGY.md) for the full catalog boundary and [PENDING.md](PENDING.md) for candidates still under review.
...
To capture a new live snapshot and regenerate all catalog pages:
...
Catalog data, documentation, and generated catalog pages are licensed under [CC BY 4.0](LICENSES/CC-BY-4.0.txt). Scripts and tests are licensed under [MIT](LICENSES/MIT.txt). Upstream projects retain their own licenses.
